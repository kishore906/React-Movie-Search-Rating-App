...
function App() {
  ...
  // below {movies, isLoading, error } are returned from the custom hook useMovies()
  const { movies, isLoading, error } = useMovies(query);

  // getting watched movie list from localstorage adn assigning to watched state variable
