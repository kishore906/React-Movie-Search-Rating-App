...
function App() {
  ...
  const [watched, setWatched] = useLocalStorageState([], "watched"); // useLocalStorageState hook
...
function Search({ query, setQuery }) {
  ...
  // using custom hook useKey to perform focus event on pressing 'Enter' button
  ...
  // above code is the replacement of this code using custom hook useKey()
  /*
  useEffect(() => {
    function callback(e) {
      if (e.code === "Enter") {
...
function MovieDetails({ selectedId, onCloseMovie, onAddWatched, watched }) {
  ...
  // using custom hook useKey() to perform useEffect() which closes the Movie Component when 'Escape' button is pressed
